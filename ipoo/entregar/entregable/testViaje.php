...
$responsable1 = new ResponsableV(15, 27, 'Tomas', 'Salto');
$responsable2 = new ResponsableV(10, 75, 'Rocio', 'Valenzuela');
$responsable3 = new ResponsableV(13, 46, 'Dario', 'Pedraza');
//Creacion de pasajeros
$pasajero1 = new Pasajero('Hernan', 'Sandroni', 12345678, 45678);
$pasajero2 = new Pasajero('Tomas', 'Ferrin', 45678945, 102345);
$pasajero3 = new Pasajero('Facundo', 'Anca', 4567852, 1234587);
$pasajero4 = new Pasajero('Juan', 'Ferro', 4679852, 4268753);
//Creacion empresa
$empresa1 = new Empresa('Travel');
//Creacion viajes
...
function viaje($objViaje){
    ...
    do {
        ...
        switch ($opcion) {
            ...
            case '2':
                echo "El viaje posee como destino a: {$objViaje->getDestino()}. \n";
            ...
            case '3':
                echo "El viaje posee {$objViaje->getPasajerosMax()} asientos. \n";
                echo "Ingrese la nueva cantidad de asientos: \n";
                $cantidadAsientos = trim(fgets(STDIN));
                $cantidadAsientos = intval($cantidadAsientos);
                $objViaje->setPasajerosMax($cantidadAsientos);
                break;

            case '4':
                if ($objViaje->consultarLugar()) {
            ...
            case '5':
                ...
                if ($objViaje->eliminarPasajero($dniSeleccionado)) {
